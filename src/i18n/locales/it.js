...
export default {
  ...
  auth: {
    ...
    marketingInfo: 'Chi: solo Versemove, mai terze parti. Come: via mail, all\'indirizzo con cui ti registri. Cosa: novità sull\'app, nuovi mondi e funzioni — nessuna pubblicità esterna.',
